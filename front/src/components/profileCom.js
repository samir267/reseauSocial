...
function ProfileCom({  theme}) {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-black" : "bg-white"} w-4/5 h-110 shadow-md rounded-3xl overflow-hidden flex flex-col items-center justify-center text-black dark:text-white`}>
      ...
      src="data:image/jpeg;base64,"
        alt="smallUserPic"
        className="w-20 h-20 rounded-full -mt-10 border-4 border-white dark:border-pink"
      />

<h1 className={`${theme === "dark" ? "text-white" : "text-black"} text-xl font-bold mt-2`}
>{user.name}</h1>
...
<div className="flex justify-around w-full mt-4">
  <div className="text-center">
    ...
    <p className={`text-xs ${theme === "dark" ? "text-white" : "text-black"}`}>
      Followers
    </p>
  </div>
  <div className="text-center">
